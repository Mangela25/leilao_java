...
public class cadastroVIEW extends javax.swing.JFrame {
    ...
    private void cadastroNomeActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // Ação para o campo de nome (se necessário)
    }                                            

    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // Cria um objeto Produto e o cadastra
     ...
     * A tela de cadastro será a principal.
     */
    public static void main(String args[]) {
        ...
        /* Criar e exibir o formulário de cadastro */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cadastroVIEW().setVisible(true); // Exibe a tela de cadastro
            }
        });
    }
